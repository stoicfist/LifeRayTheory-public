...
$\mathcal{F}_k(t)$~\index{Core Concepts!fragment chain@\textit{fragment chain} \ensuremath{\mathcal{F}_k(t)}},
...
We denote by $\mathbin{\|}$ the concatenation~\index{Structural Operators!concatenation@\textit{concatenation} \ensuremath{\|}}
...
We model this process by an integration operator $A_k$~\index{Structural Operators!integration@\textit{integration} \ensuremath{A_k}} acting on the memory structure of a
single agent $k$:
